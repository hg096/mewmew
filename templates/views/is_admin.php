    ...
    <div class="wrapper">
        <header>
            ...
            <div id="header-lg">
                ...
                <div>
                    <ul id="top-nav">
                        <li><a class="flex items-center " href="<?= BASE_URL ?>welcome/greeting"><i class="fa fa-home mr-2 w-4 "></i>홈</a></li>
                        <li><a class="flex items-center " href="<?= BASE_URL ?>"><i class="fa fa-lightbulb-o mr-2 w-4"></i>연락하기</a></li>
                        <li><a class="flex items-center " href="<?= BASE_URL ?>"><i class="fa fa-lightbulb-o mr-2 w-4"></i>홈으로</a></li>
