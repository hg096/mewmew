...
class Members extends Trongate {
    ...
    private array $per_page_options = array(10, 20, 50, 100);
    private string $user_level_title = 'member';
    private int $user_level_id = 2;
    private string $template_to_use = 'public';
